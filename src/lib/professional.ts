...
export const professionalWorks: ProfessionalWork[] = [
  ...
  },
  {
    ...
    pillBg: "#77e4c614",
    pillBorder: "#77e4c62e",
    techStack: ["Next.js", "JavaScript", "TypeScript", "Firebase", "PayArc", "Twilio"],
    hasProblem: false,
  },
  {
    id: "verifylead",
    locked: false,
    gradient: "linear-gradient(165deg, #0d0925, #442ed7 85%)",
    glow: "#6d5cf0",
    coverImage: "https://minio-api.cristianpuentes.com/portfolio-media/covers/verifylead-card.jpg",
    href: "https://www.verifylead.net/",
    repo: "",
    mode: "dark",
    heroBg: "#0d0925",
    bodyBg: "#120d35",
    textPrimary: "#f1f4fc",
    textSecondary: "#8d87b5",
    accentText: "#8b7edc",
    pillBg: "#8b7edc14",
    pillBorder: "#8b7edc2e",
  ...
  },
  {
    ...
    locked: false,
    gradient: "linear-gradient(165deg, #051a18, #0f766e 85%)",
    glow: "#2dd4bf",
    coverImage: "https://minio-api.cristianpuentes.com/portfolio-media/covers/dashboardanalytics-card.jpg",
    href: "",
    repo: "",
    mode: "dark",
    heroBg: "#051a18",
    bodyBg: "#072724",
    textPrimary: "#f1f4fc",
    textSecondary: "#73b5b0",
    accentText: "#2dd4bf",
    pillBg: "#2dd4bf14",
    pillBorder: "#2dd4bf2e",
    techStack: ["Next.js", "React", "TypeScript", "PostgreSQL", "Tailwind CSS", "Redis", "Twilio"],
    hasProblem: false,
  },
  {
    id: "thesis",
    ...
    glow: "#1d4ed8",
    coverImage: "https://minio-api.cristianpuentes.com/portfolio-media/covers/thesis-card.jpg",
