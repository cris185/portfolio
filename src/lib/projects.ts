...
npm run db:seed             # loads a sample workspace (optional)`,
  ...
  },
  {
    ...
    coverImage: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-card-v2.jpg",
    screenshots: [
      { label: "Services", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-services-v2.jpg" },
      { label: "Patient Dashboard", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-patient-v2.jpg" },
      { label: "Doctor Dashboard", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-doctor-v2.jpg" },
      { label: "Appointments", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-appointments-v2.jpg" },
      { label: "Messages", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-messages-v2.jpg" },
      { label: "Secure Chat", src: "https://minio-api.cristianpuentes.com/portfolio-media/covers/chohealth-thread-v2.jpg" },
    ],
    mode: "light",
    heroBg: "#0b1b3a",
    bodyBg: "#eaf2ff",
